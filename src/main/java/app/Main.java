...
public class Main {
    ...
    public static void runProgram() {
        ...
        Member m4 = new Member("Preben Kaas", "14085287",LocalDate.of(1983,3,20), LocalDate.of(2025,1,1), new PassiveMembership(), new PlayPreference(true, new HashSet<>(List.of(Disciplines.SINGLE, Disciplines.DOUBLE, Disciplines.MIXDOUBLE))));
        Member m5 = new Member("Olga Findsen", "13082587",LocalDate.of(2000,4,1), LocalDate.of(2025,11,1), new ActiveMembership(), new PlayPreference(false, new HashSet<>(List.of(Disciplines.SINGLE, Disciplines.DOUBLE))));
        mm.addMember(m1);
        mm.addMember(m2);
        mm.addMember(m3);
        mm.addMember(m4);
